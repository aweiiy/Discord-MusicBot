module.exports = {
  ...
  adminId: "130430908372221953", //- Replace UserId with the Discord ID of the admin of the bot
  ...
  nodes: [
    {
      ...
      host: "lavalink.micium-hosting.com", //- The host name or IP of the lavalink server.
      port: 80, // The port that lavalink is listening to. This must be a number!
      password: "micium-hosting.com", //- The password of the lavalink server.
  ...
  presence: {
    ...
    activities: [
      {
        name: "savo mamos porno", //- Status Text
        type: "WATCHING", //- PLAYING, WATCHING, LISTENING, STREAMING
      },
    ],
  },
  iconURL:
    "https://mir-s3-cdn-cf.behance.net/project_modules/disp/09ff73101435171.5f1ef5d8376bb.gif", //- This icon will be in every embed's author field
};
